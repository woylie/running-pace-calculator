...
{
	if (region.bg.aI === region.bz.aI)
	{
		return 'on line ' + region.bg.aI;
	}
	return 'on lines ' + region.bg.aI + ' through ' + region.bz.aI;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { cm: 'hidden', cg: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { cm: 'mozHidden', cg: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { cm: 'msHidden', cg: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { cm: 'webkitHidden', cg: 'webkitvisibilitychange' }
		: { cm: 'hidden', cg: 'visibilitychange' };
}
...
var $author$project$Distance$Distance = function (a) {
	return {$: 6, a: a};
};
...
var $author$project$Main$emptyModel = {
	T: '',
	aj: '',
	H: $author$project$Distance$Distance(
		$ianmackenzie$elm_units$Length$kilometers(0)),
	s: '',
	t: '',
	u: '',
	C: '',
...
var $author$project$Pace$secondsPerMeter = function (numSecondsPerMeter) {
	return numSecondsPerMeter;
};
var $author$project$Pace$minutesPerKilometer = function (numMinutesPerKilometer) {
	return $author$project$Pace$secondsPerMeter((numMinutesPerKilometer * 60) / 1000);
};
...
var $author$project$Pace$inSecondsPerMeter = function (_v0) {
	var numSecondsPerMeter = _v0;
	return numSecondsPerMeter;
};
var $ianmackenzie$elm_units$Duration$seconds = function (numSeconds) {
	return numSeconds;
};
var $author$project$Pace$durationFromDistanceAndPace = F2(
	function (distance, pace) {
		return $ianmackenzie$elm_units$Duration$seconds(
			$ianmackenzie$elm_units$Length$inMeters(distance) * $author$project$Pace$inSecondsPerMeter(pace));
	});
...
var $author$project$Distance$FiveKm = {$: 0};
var $author$project$Distance$FiveMi = {$: 2};
var $author$project$Distance$HalfMarathon = {$: 4};
var $author$project$Distance$Marathon = {$: 5};
var $author$project$Distance$TenKm = {$: 1};
var $author$project$Distance$TenMi = {$: 3};
var $elm$core$Basics$eq = _Utils_equal;
var $author$project$Constants$halfMarathonLength = $ianmackenzie$elm_units$Length$kilometers(21.0975);
...
var $author$project$Constants$marathonLength = $ianmackenzie$elm_units$Length$kilometers(42.195);
var $author$project$Distance$fromLength = function (length) {
	var lengthInMiles = $ianmackenzie$elm_units$Length$inMiles(length);
	var lengthInKilometers = $ianmackenzie$elm_units$Length$inKilometers(length);
	return (lengthInKilometers === 5) ? $author$project$Distance$FiveKm : ((lengthInMiles === 5) ? $author$project$Distance$FiveMi : ((lengthInKilometers === 10) ? $author$project$Distance$TenKm : ((lengthInMiles === 10) ? $author$project$Distance$TenMi : (_Utils_eq(length, $author$project$Constants$halfMarathonLength) ? $author$project$Distance$HalfMarathon : (_Utils_eq(length, $author$project$Constants$marathonLength) ? $author$project$Distance$Marathon : $author$project$Distance$Distance(length))))));
};
...
var $author$project$Pace$minutesAndSecondsPerKilometer = F2(
	function (minutes, seconds) {
		return $author$project$Pace$secondsPerMeter(((minutes * 60) + seconds) / 1000);
	});
...
var $author$project$Main$removeTrailingZeros = function (s) {
	var trim = F2(
		function (ch, acc) {
			return ((acc === '') && (ch === '0')) ? '' : _Utils_ap(
				$elm$core$String$fromChar(ch),
				acc);
		});
	return A3($elm$core$String$foldr, trim, '', s);
};
...
var $author$project$Main$roundForDisplay = function (n) {
	var precision = 4;
	var roundedN = $elm$core$String$trim(
		A2($myrho$elm_round$Round$round, precision, n));
	var whole = A3($elm$core$String$slice, 0, (-1) * (precision + 1), roundedN);
	var decimals = A2($elm$core$String$right, precision, roundedN);
	var newDecimals = $author$project$Main$removeTrailingZeros(decimals);
	return (newDecimals === '') ? whole : (whole + ('.' + newDecimals));
};
var $elm$core$Basics$idiv = _Basics_idiv;
var $elm$core$Basics$round = _Basics_round;
var $author$project$Hms$toHoursMinutesAndSeconds = function (totalSecondsFloat) {
	var totalSeconds = $elm$core$Basics$round(totalSecondsFloat);
	var hours = (totalSeconds / 3600) | 0;
	var minutes = ((totalSeconds - (3600 * hours)) / 60) | 0;
	var seconds = (totalSeconds - (3600 * hours)) - (minutes * 60);
	return _Utils_Tuple3(hours, minutes, seconds);
};
var $author$project$Main$toIntWithDefault = function (s) {
	return A2(
		$elm$core$Maybe$withDefault,
		0,
		$elm$core$String$toInt(s));
};
var $author$project$Main$updateDistance = F2(
	function (distance, model) {
		var pace = A2(
			$author$project$Pace$minutesAndSecondsPerKilometer,
			$author$project$Main$toIntWithDefault(model.C),
			$author$project$Main$toIntWithDefault(model.D));
		var distanceInMiles = $ianmackenzie$elm_units$Length$inMiles(distance);
		var distanceInKilometers = $ianmackenzie$elm_units$Length$inKilometers(distance);
		var _v0 = $author$project$Hms$toHoursMinutesAndSeconds(
			$ianmackenzie$elm_units$Duration$inSeconds(
				A2($author$project$Pace$durationFromDistanceAndPace, distance, pace)));
		var durationHours = _v0.a;
		var durationMinutes = _v0.b;
		var durationSeconds = _v0.c;
		return _Utils_update(
			model,
			{
				T: $author$project$Main$roundForDisplay(distanceInKilometers),
				aj: $author$project$Main$roundForDisplay(distanceInMiles),
				H: $author$project$Distance$fromLength(distance),
				s: $elm$core$String$fromInt(durationHours),
				t: $elm$core$String$fromInt(durationMinutes),
				u: $elm$core$String$fromInt(durationSeconds)
			});
	});
...
var $author$project$Pace$inSecondsPerKilometer = function (_v0) {
	var numSecondsPerMeter = _v0;
	return numSecondsPerMeter * 1000;
};
var $author$project$Hms$toMinutesAndSeconds = function (totalSecondsFloat) {
	var totalSeconds = $elm$core$Basics$round(totalSecondsFloat);
	var minutes = (totalSeconds / 60) | 0;
	var seconds = totalSeconds - (minutes * 60);
	return _Utils_Tuple2(minutes, seconds);
};
var $author$project$Pace$inMinutesAndSecondsPerKilometer = function (pace) {
	return $author$project$Hms$toMinutesAndSeconds(
		$author$project$Pace$inSecondsPerKilometer(pace));
};
var $author$project$Constants$metersPerMile = (5280 * 12) * 0.0254;
var $author$project$Pace$inSecondsPerMile = function (_v0) {
	var numSecondsPerMeter = _v0;
	return numSecondsPerMeter * $author$project$Constants$metersPerMile;
};
var $author$project$Pace$inMinutesAndSecondsPerMile = function (pace) {
	return $author$project$Hms$toMinutesAndSeconds(
		$author$project$Pace$inSecondsPerMile(pace));
};
...
var $author$project$Distance$toLength = function (distance) {
	switch (distance.$) {
		case 0:
			return $ianmackenzie$elm_units$Length$kilometers(5);
		case 1:
			return $ianmackenzie$elm_units$Length$kilometers(10);
		case 2:
			return $ianmackenzie$elm_units$Length$miles(5);
		case 3:
			return $ianmackenzie$elm_units$Length$miles(10);
		case 4:
			return $author$project$Constants$halfMarathonLength;
		case 5:
			return $author$project$Constants$marathonLength;
		default:
			var length = distance.a;
			return length;
	}
};
...
var $author$project$Pace$toSpeed = function (_v0) {
	var numSecondsPerMeter = _v0;
	return $ianmackenzie$elm_units$Speed$metersPerSecond(1 / numSecondsPerMeter);
};
var $author$project$Main$updatePace = F2(
	function (pace, model) {
		var speed = $author$project$Pace$toSpeed(pace);
		var distance = $author$project$Distance$toLength(model.H);
		var _v0 = $author$project$Pace$inMinutesAndSecondsPerMile(pace);
		var pacePerMileMinutes = _v0.a;
		var pacePerMileSeconds = _v0.b;
		var _v1 = $author$project$Pace$inMinutesAndSecondsPerKilometer(pace);
		var pacePerKmMinutes = _v1.a;
		var pacePerKmSeconds = _v1.b;
		var _v2 = $author$project$Hms$toHoursMinutesAndSeconds(
			$ianmackenzie$elm_units$Duration$inSeconds(
				A2($author$project$Pace$durationFromDistanceAndPace, distance, pace)));
		var durationHours = _v2.a;
		var durationMinutes = _v2.b;
		var durationSeconds = _v2.c;
		return _Utils_update(
			model,
			{
				s: $elm$core$String$fromInt(durationHours),
				t: $elm$core$String$fromInt(durationMinutes),
				u: $elm$core$String$fromInt(durationSeconds),
				C: $elm$core$String$fromInt(pacePerKmMinutes),
				D: $elm$core$String$fromInt(pacePerKmSeconds),
				N: $elm$core$String$fromInt(pacePerMileMinutes),
				O: $elm$core$String$fromInt(pacePerMileSeconds),
				Q: $author$project$Main$roundForDisplay(
					$ianmackenzie$elm_units$Speed$inKilometersPerHour(speed)),
				R: $author$project$Main$roundForDisplay(
					$ianmackenzie$elm_units$Speed$inMilesPerHour(speed))
			});
	});
var $author$project$Main$init = function () {
	var pace = $author$project$Pace$minutesPerKilometer(6);
	var distance = $ianmackenzie$elm_units$Length$kilometers(10);
	return A2(
		$author$project$Main$updatePace,
		pace,
		A2($author$project$Main$updateDistance, distance, $author$project$Main$emptyModel));
}();
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bD: fragment, bF: host, bP: path, bR: port_, bU: protocol, bV: query};
	});
...
var $elm$browser$Browser$sandbox = function (impl) {
	return _Browser_element(
		{
			cp: function (_v0) {
				return _Utils_Tuple2(impl.cp, $elm$core$Platform$Cmd$none);
			},
			cB: function (_v1) {
...
var $robinheghan$murmur3$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {ah: charsProcessed, an: hash, aa: seed, at: shift};
	});
...
var $robinheghan$murmur3$Murmur3$finalize = function (data) {
	var acc = (!(!data.an)) ? (data.aa ^ A2(
		$robinheghan$murmur3$Murmur3$multiplyBy,
		$robinheghan$murmur3$Murmur3$c2,
		A2(
			$robinheghan$murmur3$Murmur3$rotlBy,
			15,
			A2($robinheghan$murmur3$Murmur3$multiplyBy, $robinheghan$murmur3$Murmur3$c1, data.an)))) : data.aa;
	var h0 = acc ^ data.ah;
...
var $robinheghan$murmur3$Murmur3$hashFold = F2(
	function (c, data) {
		var res = data.an | ((255 & $elm$core$Char$toCode(c)) << data.at);
		var _v0 = data.at;
		if (_v0 === 24) {
			return {
				ah: data.ah + 1,
				an: 0,
				aa: A2($robinheghan$murmur3$Murmur3$mix, data.aa, res),
				at: 0
			};
		} else {
			return {ah: data.ah + 1, an: res, aa: data.aa, at: data.at + 8};
		}
	});
...
var $author$project$Hms$hoursMinutesAndSeconds = F3(
	function (hoursValue, minutesValue, secondsValue) {
		return $ianmackenzie$elm_units$Duration$seconds(((hoursValue * 3600) + (minutesValue * 60)) + secondsValue);
	});
...
var $author$project$Pace$minutesAndSecondsPerMile = F2(
	function (minutes, seconds) {
		return $author$project$Pace$secondsPerMeter(((minutes * 60) + seconds) / $author$project$Constants$metersPerMile);
	});
var $elm$core$String$toFloat = _String_toFloat;
var $author$project$Pace$paceFromDistanceAndDuration = F2(
	function (distance, newTotalTime) {
		return $author$project$Pace$secondsPerMeter(
			$ianmackenzie$elm_units$Duration$inSeconds(newTotalTime) / $ianmackenzie$elm_units$Length$inMeters(distance));
	});
var $author$project$Main$updateDuration = F2(
	function (newTotalTime, model) {
		var distance = $author$project$Distance$toLength(model.H);
		var pace = A2($author$project$Pace$paceFromDistanceAndDuration, distance, newTotalTime);
		var speed = $author$project$Pace$toSpeed(pace);
		var _v0 = $author$project$Pace$inMinutesAndSecondsPerMile(pace);
		var pacePerMileMinutes = _v0.a;
		var pacePerMileSeconds = _v0.b;
		...
		var pacePerKmSeconds = _v1.b;
		var _v2 = $author$project$Hms$toHoursMinutesAndSeconds(
			$ianmackenzie$elm_units$Duration$inSeconds(newTotalTime));
		var durationHours = _v2.a;
		var durationMinutes = _v2.b;
		var durationSeconds = _v2.c;
		return _Utils_update(
...
var $author$project$Pace$fromSpeed = function (_v0) {
	var numMetersPerSecond = _v0;
	return $author$project$Pace$secondsPerMeter(1 / numMetersPerSecond);
};
var $author$project$Main$updateSpeed = F2(
	function (speed, model) {
		var pace = $author$project$Pace$fromSpeed(speed);
		var distance = $author$project$Distance$toLength(model.H);
		var _v0 = $author$project$Pace$inMinutesAndSecondsPerMile(pace);
		var pacePerMileMinutes = _v0.a;
		var pacePerMileSeconds = _v0.b;
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 2:
				var maybeDistance = msg.a;
				if (!maybeDistance.$) {
					var distance = maybeDistance.a;
					return A2(
						$author$project$Main$updateDistance,
						$author$project$Distance$toLength(distance),
						model);
				} else {
					var distanceSelected = $author$project$Distance$Distance(
						$ianmackenzie$elm_units$Length$kilometers(
							A2(
								$elm$core$Maybe$withDefault,
								0,
								$elm$core$String$toFloat(model.T))));
					return _Utils_update(
						model,
						{H: distanceSelected});
				}
			...
			case 1:
				var s = msg.a;
				var _v3 = $elm$core$String$toFloat(s);
				if (!_v3.$) {
					var mi = _v3.a;
					var newModel = A2(
						$author$project$Main$updateDistance,
						$ianmackenzie$elm_units$Length$miles(mi),
						model);
					return _Utils_update(
						newModel,
						{aj: s});
			...
			case 3:
				...
				if (!_v4.$) {
					var minutes = _v4.a;
					var seconds = $author$project$Main$toIntWithDefault(model.D);
					return A2(
						$author$project$Main$updatePace,
						A2(
							$author$project$Pace$minutesAndSecondsPerKilometer,
							A2($elm$core$Basics$max, minutes, 0),
							seconds),
						model);
				} else {
					return _Utils_update(
			...
			case 4:
				...
				if (!_v5.$) {
					var seconds = _v5.a;
					var minutes = $author$project$Main$toIntWithDefault(model.C);
					var pace = (!minutes) ? A2(
						$author$project$Pace$minutesAndSecondsPerKilometer,
						minutes,
						A2($elm$core$Basics$max, seconds, 0)) : A2($author$project$Pace$minutesAndSecondsPerKilometer, minutes, seconds);
					return A2($author$project$Main$updatePace, pace, model);
				} else {
					return _Utils_update(
						model,
						{D: s});
			...
			case 5:
				...
				if (!_v6.$) {
					var minutes = _v6.a;
					var seconds = $author$project$Main$toIntWithDefault(model.O);
					return A2(
						$author$project$Main$updatePace,
						A2(
							$author$project$Pace$minutesAndSecondsPerMile,
							A2($elm$core$Basics$max, minutes, 0),
							seconds),
						model);
				} else {
			...
			case 6:
				var s = msg.a;
				var _v7 = $elm$core$String$toInt(s);
				if (!_v7.$) {
					var seconds = _v7.a;
					var minutes = $author$project$Main$toIntWithDefault(model.N);
					var pace = (!minutes) ? A2(
						$author$project$Pace$minutesAndSecondsPerMile,
						minutes,
						A2($elm$core$Basics$max, seconds, 0)) : A2($author$project$Pace$minutesAndSecondsPerMile, minutes, seconds);
					return A2($author$project$Main$updatePace, pace, model);
				} else {
					return _Utils_update(
						model,
			...
			case 7:
				var s = msg.a;
				var _v8 = $elm$core$String$toFloat(s);
				if (!_v8.$) {
					var value = _v8.a;
					var newModel = A2(
						$author$project$Main$updateSpeed,
						$ianmackenzie$elm_units$Speed$kilometersPerHour(value),
						model);
					return _Utils_update(
						newModel,
						{Q: s});
			...
			case 8:
				var s = msg.a;
				var _v9 = $elm$core$String$toFloat(s);
				if (!_v9.$) {
					var value = _v9.a;
					var newModel = A2(
						$author$project$Main$updateSpeed,
						$ianmackenzie$elm_units$Speed$milesPerHour(value),
						model);
					return _Utils_update(
						newModel,
						{R: s});
			...
			case 9:
				var s = msg.a;
				var _v10 = $elm$core$String$toInt(s);
				if (!_v10.$) {
					var hoursValue = _v10.a;
					var secondsValue = $author$project$Main$toIntWithDefault(model.u);
					var minutesValue = $author$project$Main$toIntWithDefault(model.t);
					return A2(
						$author$project$Main$updateDuration,
						A3(
							$author$project$Hms$hoursMinutesAndSeconds,
							A2($elm$core$Basics$max, hoursValue, 0),
							minutesValue,
							secondsValue),
						model);
				} else {
			...
			case 10:
				var s = msg.a;
				var _v11 = $elm$core$String$toInt(s);
				if (!_v11.$) {
					var minutesValue = _v11.a;
					var secondsValue = $author$project$Main$toIntWithDefault(model.u);
					var hoursValue = $author$project$Main$toIntWithDefault(model.s);
					var duration = (!hoursValue) ? A3(
						$author$project$Hms$hoursMinutesAndSeconds,
						hoursValue,
						A2($elm$core$Basics$max, minutesValue, 0),
						secondsValue) : A3($author$project$Hms$hoursMinutesAndSeconds, hoursValue, minutesValue, secondsValue);
					return A2($author$project$Main$updateDuration, duration, model);
				} else {
					return _Utils_update(
						model,
						{t: s});
			...
			default:
				var s = msg.a;
				var _v12 = $elm$core$String$toInt(s);
				if (!_v12.$) {
					var secondsValue = _v12.a;
					var minutesValue = $author$project$Main$toIntWithDefault(model.t);
					var hoursValue = $author$project$Main$toIntWithDefault(model.s);
					var duration = ((!hoursValue) && (!minutesValue)) ? A3(
						$author$project$Hms$hoursMinutesAndSeconds,
						hoursValue,
						minutesValue,
						A2($elm$core$Basics$max, secondsValue, 0)) : A3($author$project$Hms$hoursMinutesAndSeconds, hoursValue, minutesValue, secondsValue);
					return A2($author$project$Main$updateDuration, duration, model);
				} else {
					return _Utils_update(
						model,
...
var $author$project$Main$SetKilometers = function (a) {
	return {$: 0, a: a};
};
var $author$project$Main$SetMiles = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$SetPacePerKmMinutes = function (a) {
	return {$: 3, a: a};
};
var $author$project$Main$SetPacePerKmSeconds = function (a) {
	return {$: 4, a: a};
};
var $author$project$Main$SetPacePerMileMinutes = function (a) {
	return {$: 5, a: a};
};
var $author$project$Main$SetPacePerMileSeconds = function (a) {
	return {$: 6, a: a};
};
var $author$project$Main$SetSpeedInKmh = function (a) {
	return {$: 7, a: a};
};
var $author$project$Main$SetSpeedInMph = function (a) {
	return {$: 8, a: a};
};
var $author$project$Main$SetTotalTimeHours = function (a) {
	return {$: 9, a: a};
};
var $author$project$Main$SetTotalTimeMinutes = function (a) {
	return {$: 10, a: a};
};
var $author$project$Main$SetTotalTimeSeconds = function (a) {
	return {$: 11, a: a};
};
		...
		switch (declaration.$) {
			...
			case 6:
				...
				return $elm$core$String$isEmpty(record.ch) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
					A3($elm$core$Dict$insert, record.cs, record.ch, keyframesByName),
					declarations);
			case 7:
				var properties = declaration.a;
				return $elm$core$List$isEmpty(properties) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
...
var $rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_v0) {
	...
	var declarations = _v0.ci;
	return {
		bv: charset,
		ci: $rtfeldman$elm_css$Css$Structure$compactDeclarations(declarations),
		bG: imports,
		bM: namespaces
	};
};
...
var $rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_v0) {
	...
	var declarations = $rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2($elm$core$List$concatMap, $rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {bv: charset, ci: declarations, bG: imports, bM: namespaces};
};
...
var $rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {bv: $elm$core$Maybe$Nothing, bG: _List_Nil, bM: _List_Nil, b0: snippets};
};
...
var $rtfeldman$elm_css$Css$stringsToValue = function (list) {
	return $elm$core$List$isEmpty(list) ? {E: 'none'} : {
		E: A2($elm$core$String$join, ', ', list)
	};
};
...
var $author$project$Distance$distances = _List_fromArray(
	[$author$project$Distance$FiveKm, $author$project$Distance$TenKm, $author$project$Distance$FiveMi, $author$project$Distance$TenMi, $author$project$Distance$HalfMarathon, $author$project$Distance$Marathon]);
var $author$project$Distance$toString = function (distance) {
	switch (distance.$) {
		case 0:
			return '5 km';
		case 2:
...
var $author$project$Distance$fromString = function (s) {
	return _Utils_eq(
		s,
		$author$project$Distance$toString($author$project$Distance$FiveKm)) ? $elm$core$Maybe$Just($author$project$Distance$FiveKm) : (_Utils_eq(
		s,
		$author$project$Distance$toString($author$project$Distance$FiveMi)) ? $elm$core$Maybe$Just($author$project$Distance$FiveMi) : (_Utils_eq(
		s,
		$author$project$Distance$toString($author$project$Distance$TenKm)) ? $elm$core$Maybe$Just($author$project$Distance$TenKm) : (_Utils_eq(
		s,
		$author$project$Distance$toString($author$project$Distance$TenMi)) ? $elm$core$Maybe$Just($author$project$Distance$TenMi) : (_Utils_eq(
		s,
		$author$project$Distance$toString($author$project$Distance$HalfMarathon)) ? $elm$core$Maybe$Just($author$project$Distance$HalfMarathon) : (_Utils_eq(
		s,
...
var $rtfeldman$elm_css$Css$prop3 = F4(
	function (key, argA, argB, argC) {
		return A2($rtfeldman$elm_css$Css$property, key, argA.E + (' ' + (argB.E + (' ' + argC.E))));
	});
var $rtfeldman$elm_css$Css$border3 = $rtfeldman$elm_css$Css$prop3('border');
var $rtfeldman$elm_css$Css$borderRadius = $rtfeldman$elm_css$Css$prop1('border-radius');
var $rtfeldman$elm_css$Css$prop2 = F3(
	function (key, argA, argB) {
		return A2($rtfeldman$elm_css$Css$property, key, argA.E + (' ' + argB.E));
	});
var $rtfeldman$elm_css$Css$margin2 = $rtfeldman$elm_css$Css$prop2('margin');
var $rtfeldman$elm_css$Css$PxUnits = 0;
var $rtfeldman$elm_css$Css$px = A2($rtfeldman$elm_css$Css$Internal$lengthConverter, 0, 'px');
var $rtfeldman$elm_css$Css$solid = {n: 0, ab: 0, E: 'solid'};
...
var $rtfeldman$elm_css$Css$wrap = {aE: 0, aV: 0, E: 'wrap'};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($rtfeldman$elm_css$Html$Styled$Attributes$style, 'gap', '0.375rem 0.75rem')
				]),
			_Utils_ap(
				_List_fromArray(
					[
...
var $author$project$Components$numberInput = F4(
	function (inputId, currentValue, event, minValue) {
					...
					[
						...
						_List_fromArray(
							[
								...
								'rpc-field-km',
								model.T,
								$author$project$Main$SetKilometers,
					...
					[
						...
						_List_fromArray(
							[
								...
								'rpc-field-pace-km-minutes',
								model.C,
								$author$project$Main$SetPacePerKmMinutes,
								$elm$core$Maybe$Just(0))
							])),
						A3(
						$author$project$Components$field,
						...
						_List_fromArray(
							[
								A4($author$project$Components$numberInput, 'rpc-field-pace-km-seconds', model.D, $author$project$Main$SetPacePerKmSeconds, $elm$core$Maybe$Nothing)
							]))
					])),
				A2(
				$author$project$Components$fieldset,
					...
					[
						...
						_List_fromArray(
							[
								...
								'rpc-field-pace-mi-minutes',
								model.N,
								$author$project$Main$SetPacePerMileMinutes,
								$elm$core$Maybe$Just(0))
							])),
						A3(
						$author$project$Components$field,
						...
						_List_fromArray(
							[
								A4($author$project$Components$numberInput, 'rpc-field-pace-mi-seconds', model.O, $author$project$Main$SetPacePerMileSeconds, $elm$core$Maybe$Nothing)
							]))
					])),
				A2(
				$author$project$Components$fieldset,
					...
					[
						...
						_List_fromArray(
							[
								...
								'rpc-field-speed-kmh',
								model.Q,
								$author$project$Main$SetSpeedInKmh,
								$elm$core$Maybe$Just(0))
							])),
						A3(
						$author$project$Components$field,
						...
						_List_fromArray(
							[
								...
								'rpc-field-speed-mih',
								model.R,
								$author$project$Main$SetSpeedInMph,
								$elm$core$Maybe$Just(0))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								'rpc-field-duration-hours',
								model.s,
								$author$project$Main$SetTotalTimeHours,
								$elm$core$Maybe$Just(0))
							])),
						A3(
						$author$project$Components$field,
						...
						_List_fromArray(
							[
								A4($author$project$Components$numberInput, 'rpc-field-duration-minutes', model.t, $author$project$Main$SetTotalTimeMinutes, $elm$core$Maybe$Nothing)
							])),
						A3(
						$author$project$Components$field,
						...
						_List_fromArray(
							[
								A4($author$project$Components$numberInput, 'rpc-field-duration-seconds', model.u, $author$project$Main$SetTotalTimeSeconds, $elm$core$Maybe$Nothing)
							]))
					]))
			]));
};
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{
		...
		cF: A2($elm$core$Basics$composeR, $author$project$Main$view, $rtfeldman$elm_css$Html$Styled$toUnstyled)
	});
